...
import beingSevakStamp from '../../beingsevakstamp.png'
    ...
    <div style={{ maxWidth: '900px', margin: 'auto', fontFamily: "'Segoe UI', Arial, sans-serif" }}>
      ...
      <div style={{ background: '#fff', border: `2px solid ${ACCENT}`, borderRadius: '10px', padding: '22px', marginBottom: '20px' }}>
        ...
        <div style={{ width: '100%', display: 'table', borderBottom: `2px solid ${ACCENT}`, paddingBottom: '12px', marginBottom: '10px' }}>
          <div style={{ display: 'table-cell', width: '90px', verticalAlign: 'top' }}>
            <img src={beingSevakLogo} alt="Logo" style={{ width: '70px', height: 'auto', display: 'block' }} />
          </div>
        ...
        <div style={{ marginTop: '18px', fontSize: '14px', lineHeight: '1.7', color: '#222' }}>
          ...
          <p>Dear Sir/Madam,</p>
          <p>
            <strong style={{ color: ACCENT }}>Being Sevak Charitable Trust</strong>, would like to thanks you for your generous donation of
            <strong style={{ fontWeight: 700, borderBottom: `2px solid ${ACCENT}`, paddingBottom: '5px' }}> {amountInWords(amount)}</strong>
            <span style={{ fontWeight: 700, marginLeft: '8px', marginRight: '8px' ,color: '#0a3d62' }}>Rs. {formatAmount(amount)}</span>
          ...
          <p>Please keep this written acknowledgement of your donation for your tax records.</p>
          <p>
            We thank you once again for your support and love we have received from you, We also hope forward to
      ...
      <div style={{ background: '#fff', border: `2px solid ${ACCENT}`, borderRadius: '10px', padding: '22px' }}>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', border: `2px solid ${ACCENT}` }}>
          <tbody>
            <tr>
              <td style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 700,  background: '#f3fbff', width: '25%' }}>Receipt No:</td>
              <td style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 600, color: '#222', background: '#fff' }}>{donor['Receipt No.']}</td>
              <td style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 700,  background: '#f3fbff', width: '25%', textAlign: 'right' }}>Dated:</td>
              <td style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 600, color: '#222', background: '#fff' }}>{formattedDate}</td>
            </tr>
            <tr>
              <td style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 700,  background: '#f3fbff' }} colSpan="1">RECEIVED with thanks from Ms./Mr./Miss.</td>
              <td style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 600, color: '#222', background: '#fff' }} colSpan="3">{donor['Donor Name']}</td>
            </tr>
            <tr>
              <td style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 700,  background: '#f3fbff' }}>Address:</td>
              <td style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 600, color: '#222', background: '#fff' }} colSpan="3">
                {donor['Address 1'] || 'NA'}
            ...
            <tr>
              <td style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 700,  background: '#f3fbff' }}>The Sum of Rupees:</td>
              <td style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 600, color: '#222', background: '#fff' }} colSpan="3">{amountInWords(amount)}</td>
            </tr>
            <tr>
              <td style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 700,  background: '#f3fbff' }}>Mode of Payment:</td>
              <td style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 600, color: '#222', background: '#fff' }}>{donor['Mode of Payment (MOP)']}</td>
              <td style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 700,  background: '#f3fbff', textAlign: 'right' }}>Payment ID No:</td>
              <td style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 600, color: '#222', background: '#fff' }}>{donor['Payment ID No.']}</td>
            </tr>
            <tr>
              <td style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 700,  background: '#f3fbff' }}>Bank Name:</td>
              <td style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 600, color: '#222', background: '#fff' }}>{donor['Donor Bank Name'] || 'NA'}</td>
              <td style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 700,  background: '#f3fbff', textAlign: 'right' }} colSpan="1"></td>
              <td style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 600, color: '#222', background: '#fff' }}></td>
            </tr>
            <tr>
              <td style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 700,  background: '#f3fbff' }}>On Account Of:</td>
              <td style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 600, color: '#222', background: '#fff' }} colSpan="3">{donor['Account Of'] || 'Corpus'}</td>
            </tr>
          </tbody>
        </table>
        ...
        <div style={{ display: 'flex', gap: '20px', marginTop: '18px' }}>
          <div style={{ flex: 1, border: `2px solid ${ACCENT}`, borderRadius: '8px', padding: '14px', background: '#fff' }}>
            ...
            <div style={{ fontSize: '11px', color: '#555', marginTop: '5px' }}>Donation Payment is Subject to Realisation</div>
            ...
            <div style={{ fontSize: '11px', color: '#555', marginTop: '5px' }}>****This is system generated auto receipt****</div>
          </div>
